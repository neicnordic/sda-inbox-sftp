...
def main():
    ...
    certfile = "/tls/cega.pem"
    keyfile = "/tls/cega-key.pem"
...
def load_users():
    ...
    instances[os.environ[f"CEGA_USERS_USER"]] = os.environ[
        f"CEGA_USERS_PASSWORD"
    ]  #'legatest'  # Hard-coding legatest:legatest
